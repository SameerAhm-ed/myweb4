...
if (isset($_POST["btnUpdate"])) {
    ...
    if ($_ErrorMessage == "") {
        ...
        $Query = "";
        if ($varFileError == 0) {
            $Query = "UPDATE `tbl_users` SET first_name='$getFirstName', last_name='$getLastName', profile_pic='$varFilePath' where id='$_SESSION[UserID]' ";
        } else {
    ...
    <div class="container">
        ...
        <form class="form-horizontal" action="profile.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <img id="uploadPreview" src="<?php if (isset($varUserPic)) {
                                                        echo $varUserPic;
                                                    } else {
                                                        echo "";
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" value="<?php if (isset($varFN)) {
                                                                        echo $varFN;
                                                                    } else {
                                                                        echo "";
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" value="<?php if (isset($varLastN)) {
                                                                        echo $varLastN;
                                                                    } else {
                                                                        echo "";
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="email" readonly class="form-control" value="<?php if (isset($varUserN)) {
                                                                                    echo $varUserN;
                                                                                } else {
                                                                                    echo "";
